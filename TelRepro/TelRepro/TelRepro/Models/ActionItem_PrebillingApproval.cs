namespace TelRepro.Models
{
    public partial class ActionItem
    {
        ...
        private bool _rentIncluded;

        public bool RentIncluded
        {
            get { return _rentIncluded; }
            set
            {
                _rentIncluded = value;
                OnPropertyChanged();
        ...
        public void SetPrebillingAttributes()
        {
            ...
            //if (Details.TryGetValue("RentIncluded", out oout))
            //{
            //    if (bool.TryParse(oout.ToString(), out z))
            //        RentIncluded = z;
            //}
        }
    }
